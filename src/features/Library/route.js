...
router.post(
  ...
  upload.fields([
    ...
    { name: "previewPagesImages", maxCount: 20 },
    { name: "previewPagesPdf", maxCount: 1 },
    { name: "previewPagesVideo", maxCount: 1 },
    { name: "previewPagesAudio", maxCount: 1 },
    { name: "tableOfContentsImages", maxCount: 20 },
    { name: "tableOfContentsPdf", maxCount: 1 },
    { name: "tableOfContentsVideo", maxCount: 1 },
    { name: "tableOfContentsAudio", maxCount: 1 },
    { name: "abstractPreviewImages", maxCount: 20 },
    { name: "abstractPreviewPdf", maxCount: 1 },
    { name: "abstractPreviewVideo", maxCount: 1 },
    { name: "abstractPreviewAudio", maxCount: 1 },
    { name: "otherPreviewPagesImages", maxCount: 20 },
    { name: "otherPreviewPagesPdf", maxCount: 1 },
    { name: "otherPreviewPagesVideo", maxCount: 1 },
    { name: "otherPreviewPagesAudio", maxCount: 1 },
  ]),
